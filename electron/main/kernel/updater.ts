...
const KERNEL_VERSION = '1.0.1'
const KERNEL_DOWNLOAD_URL = 'https://olivedownlod.s3.ap-northeast-2.amazonaws.com/main(1.0.1).zip'
const KERNEL_DOWNLOAD_URL_MAC = 'https://olivedownlod.s3.ap-northeast-2.amazonaws.com/main-darwin(1.0.1).zip'
...
async function getServiceVersion(): Promise<ServiceVersion | null> {
  ...
  return {
    ...
    download_url: process.platform === 'darwin' ? KERNEL_DOWNLOAD_URL_MAC : KERNEL_DOWNLOAD_URL,
  }

  // TODO: Supabase 연동 코드 (나중에 사용)
  /*
