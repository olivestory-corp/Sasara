  ...
  (
    ...
    return (
      <textarea
        ...
        ref={textAreaRef}
        className={cn(
          'no-scrollbar flex w-full resize-none bg-transparent px-3 py-2 placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
          className,
        )}
        onChange={(e) => {
